...
<div class="login_container">
    ...
    <div class="login_box">
        ...
        <el-form :model="PandE" ref="PandEFormRef">
            ...
            <el-input v-model="PandE.username" autocomplete="off" placeholder="请输入用户名" style="width:200px; margin-right: 400px;"></el-input>
            </el-form-item>
            <el-form-item label="手机" :label-width="formLabelWidth">
            <el-input v-model="PandE.phone" autocomplete="off" placeholder="请输入手机号" style="width:200px; margin-right: 400px;"></el-input>
            </el-form-item>
            <el-form-item label="邮箱" :label-width="formLabelWidth">
            <el-input v-model="PandE.email" autocomplete="off" placeholder="请输入邮箱" style="width:200px; margin-right: 400px;"></el-input>
            </el-form-item> 
        </el-form>
